...
int main(int argc, char* argv[]) {
    ...
    int socket_storage = crearConexion(config_worker->ip_storage,config_worker->puerto_storage);
    ...
    int socket_master = crearConexion(config_worker->ip_master,config_worker->puerto_master);
